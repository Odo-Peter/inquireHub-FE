      ...
      {!userInfo ? (
        <div className="flex flex-col items-center justify-center h-full w-full gap-y-3">
          ...
          <h1 className="text-2xl text-center font-extrabold inline-block text-transparent bg-gradient-to-r from-pink-400 to-yellow-500 bg-clip-text">
            <span className="text-3xl">InquireHub</span> is preparing your feed
            page...
          </h1>
          ...
          <Link
            to={'/auth/sign_in'}
            className="clicked bg-gradient-to-r flex items-center justify-center gap-x-2 from-pink-500 to-blue-500 text-white text-center w-[60%] md:w-[40%] py-[10px] rounded-full font-medium mt-6 transition-all hover:bg-gradient-to-r hover:from-blue-500 hover:to-pink-500"
          >
